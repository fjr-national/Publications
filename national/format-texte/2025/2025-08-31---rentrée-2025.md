...
<div style="border: 2px solid gray; padding: 1em; max-width: 500px; font-family: Arial, sans-serif;">
  <h2 style="margin-bottom: 0.3em; font-size: 1.5em;">
    Meeting ouvrier et jeune à Paris le 4 octobre
  </h2>

  <p><em>« Pour l'unité pour le retrait du plan Macron-Bayrou et pour la défense de la Sécurité sociale ».</em></p>

  <p>Tu veux y participer ?</p>
  <p>Contacte-nous pour t’inscrire !</p>

  <a href="https://linkin.bio/fjr_national" 
     target="_blank" 
     rel="noopener" 
     style="display: inline-block; margin-top: 0.5em; padding: 0.5em 1em; background-color: #d32f2f; color: white; text-decoration: none; border-radius: 4px;">
    Nous contacter
  </a>
</div>
